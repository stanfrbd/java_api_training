...
class RequestHandlerTest {
    ...
    void correct_start_request() {
        ProjectServer s = null;
        try {
            s = ProjectServerTest.StartTestServer("9879");
        } catch (Exception e) {
            e.printStackTrace();
        ...
        ProjectServerTest.StopServer(s);
    }
    ...
    void bad_start_request() {
        ProjectServer s = null;
        try {
            s = ProjectServerTest.StartTestServer("9880");
        } catch (Exception e) {
            e.printStackTrace();
            Assertions.assertEquals(0, 1, "Number of exception on server");
        }
    ...
    void no_more_ships_to_shoot() throws IOException {
        ProjectServer s = null;
        try {
            s = ProjectServerTest.StartTestServer("9899");
